...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/curly-snow-6b20
```

A live public deployment of this template is available at [https://curly-snow-6b20.templates.workers.dev](https://curly-snow-6b20.templates.workers.dev)
